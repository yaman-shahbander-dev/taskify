...
use App\Application\Company\V1\Http\Resources\Company\TaskPaginatedResource;
...
use App\Domain\Company\Actions\GetTasksAction;
...
class TaskController extends BaseController
{
     ...
     *                 property="data",
     *                 type="array",
     *                 @OA\Items(ref="#/components/schemas/Company_TaskPaginatedResponse")
     *             ),
     *             @OA\Property(
     *                 property="meta",
    ...
    public function index(): JsonResponse
    {
        ...
        $userId = auth()->user()->id;
        $tasks = app(GetTasksAction::class)($userId);

        return $this->okResponse(TaskPaginatedResource::collection($tasks));
    }
